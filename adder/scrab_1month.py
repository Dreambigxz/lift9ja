...
#0print(client.get_me().stringify())
client.send_message(entity='Peektop', message='fuck')
...
with open("{}/{} 1month.csv".format(path, group_name),"w",encoding='UTF-8') as f:
    ...
    for user in all_participants:
        ...
        if status <= utc.localize(datetime.datetime.today()) - timedelta(days=30):
