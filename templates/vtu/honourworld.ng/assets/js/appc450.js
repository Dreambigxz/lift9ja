...
(function ($) {
    ...
    var accountText = $(".copy-account-to-clipboard");

    console.log("account chck");


    accountText.click(function() {
        copy(this);
        ...
        toastr.success('Account Number copied successfully');
    })
    ...
    var userText = $(".copy-referral-to-clipboard");
    var btnCopy = $(".copy-referral-btn");
    ...
    wind_.on('load', function () {
        $('.preloader').fadeOut(400, function () {
            setTimeout(function () {
                ...
                toastr.success('Welcome back '+$authuser);
